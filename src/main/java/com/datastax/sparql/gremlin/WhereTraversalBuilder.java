...
class WhereTraversalBuilder {
    ...
    public static GraphTraversal<?, ?> transform(final E_LessThan expression) {
    	// Printing intermediate filter values 
    	System.out.println(" The less than Value: "+ __.as(expression.getArg1().getVarName()).inV());
    	//System.out.println(" The less than Value: "+ __.as(expression.getArg1().getVarName()).value()); 
    	//System.out.println(" The less than Value: "+ expression.getArg2().getConstant().getNode().getLiteralValue());
    	//System.out.println(" The less than Value: "+ expression.getArg1().getVarName());
    	final Object value = expression.getArg2().getConstant().getNode().getLiteralValue();
